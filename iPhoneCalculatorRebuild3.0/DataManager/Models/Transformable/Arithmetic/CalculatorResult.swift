...
public class CalculatorResult: NSObject, NSSecureCoding, TermProtocol {
    ...
    private class Operation: PrecedenceOperation {
        
        required init(reverseTerm: CalculatorResult, leftTerm: TermProtocol, rightTerm: TermProtocol, basicOperator: CalculatorFunction) {
            super.init(reverseTerm: DoubleNumber(doubleValue: 0), leftTerm: nil, rightTerm: nil, basicOperator: nil)
        }
        ...
        for parentheticalExpression in parentheticalExpressionContainers.parentheticalExpressions.reversed() {
            if parentheticalExpression.termTestIdentifier == parentheticalExpressionContainers.parentheticalExpressions.first?.termTestIdentifier {
                ...
                case carryOverDoubleNumber != nil:
                    ...
                    self.term = PrecedenceOperation(reverseTerm: self, leftTerm: leftTerm, rightTerm: rightNumber, basicOperator: basicOperator)
