...
public class PrecedenceOperation: NSObject, NSSecureCoding, TermProtocol {
    ...
    var reverseTerm: ParentheticalExpression!
    ...
    init(reverseTerm: TermProtocol, leftTerm: TermProtocol? = nil, rightTerm: TermProtocol? = nil, basicOperator: CalculatorFunction? = nil) {
        self.negateNumber = false
        self.termType = .operation
        self.termTestIdentifier = UUID()
        self.reverseTerm = reverseTerm as! ParentheticalExpression
...
//        self.reverseParentheticalExpression = {
//            guard let termType: Term = {
//                guard let number = coder.decodeObject(of: NSNumber.self, forKey: Key.reverseParentheticalExpression.rawValue) else { return nil }
//                guard let termType = Term.init(rawValue: number.intValue) else { fatalError() }
//                return termType
//            }() else { return nil }
//            let termKey = Key.rightTerm.rawValue
...
//        coder.encode(self.reverseParentheticalExpression, forKey: Key.reverseParentheticalExpression.rawValue)
//        coder.encode(NSNumber(value: reverseParentheticalExpression.termType.rawValue), forKey: Key.reverseParentheticalExpressionTermType.rawValue)
    }
}
