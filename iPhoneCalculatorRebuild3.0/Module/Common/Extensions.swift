...
extension UICollectionViewCompositionalLayout {
    ...
    static var calculatorFunctionsLayout: UICollectionViewCompositionalLayout {
        fatalError()
    }
}
...
extension CGSize: Comparable, Hashable {
    ...
    public static func < (lhs: CGSize, rhs: CGSize) -> Bool {
        let leftSquareArea: CGFloat = lhs.height * lhs.height
        let rightSquareArea: CGFloat = rhs.height * rhs.height
        
        return leftSquareArea < rightSquareArea
    }
